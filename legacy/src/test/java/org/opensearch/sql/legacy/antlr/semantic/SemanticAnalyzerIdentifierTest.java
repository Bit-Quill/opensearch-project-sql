...
public class SemanticAnalyzerIdentifierTest extends SemanticAnalyzerTestBase {
  ...
  public void useKeywordInMultiFieldShouldPass() {
    validate(
        "SELECT employer.keyword FROM semantics WHERE employer.keyword LIKE 'AWS' GROUP BY employer.keyword");
  ...
  public void useConstantLiteralInSelectClauseShouldPass() {
    ...
    // validate("SELECT 'test' FROM semantics"); TODO: why 'test' goes to fullColumnName that can be
    // string literal
