...
public class SemanticAnalyzerScalarFunctionTest extends SemanticAnalyzerTestBase {
  ...
  public void unsupportedScalarFunctionCallInSelectClauseShouldFail() {
    expectValidationFailWithErrorMessages(
        "SELECT DAY() FROM semantics", "Function [DAY] cannot be found or used here.");
  }
  ...
  @Ignore(
      "Test set to ignore due to nested functions not supported and blocked by throwing SqlFeatureNotImplementedException")
  @Test
