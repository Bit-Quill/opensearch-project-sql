...
public class QueryPlannerExecuteTest extends QueryPlannerTest {
  ...
  public void simpleJoin() {
    MatcherAssert.assertThat(
        ...
        hits(
            hit(MatcherUtils.kv("d.name", "AWS"), MatcherUtils.kv("e.lastname", "Alice")),
            hit(MatcherUtils.kv("d.name", "AWS"), MatcherUtils.kv("e.lastname", "Hank"))));
  }
  ...
  public void simpleLeftJoinWithSelectAllFromOneTable() {
    MatcherAssert.assertThat(
        query(
            ...
            employees(
                employee(1, "Alice", "1"), employee(2, "Hank", "1"), employee(3, "Allen", "3")),
            departments(department(1, "1", "AWS"), department(2, "2", "Retail"))),
        hits(
            hit(
                MatcherUtils.kv("e.lastname", "Alice"),
                MatcherUtils.kv("d.name", "AWS"),
    ...
    MatcherAssert.assertThat(
        query(
            "SELECT d.name, e.lastname FROM employee e "
                + "  JOIN department d ON d.id = e.departmentId "
                + "    WHERE d.region = 'US' AND e.age > 30",
            employees(employee(1, "Alice", "2"), employee(2, "Hank", "3")),
            departments(department(1, "1", "AWS"))),
        hits());
  }
  ...
  public void simpleJoinWithSomeMatches() {
    MatcherAssert.assertThat(
        query(
            ...
            employees(employee(1, "Alice", "2"), employee(2, "Hank", "3")),
            departments(department(1, "1", "AWS"), department(2, "2", "Retail"))),
        hits(hit(MatcherUtils.kv("d.name", "Retail"), MatcherUtils.kv("e.lastname", "Alice"))));
  }
    ...
    MatcherAssert.assertThat(
        query(
            "SELECT d.name, e.lastname FROM employee e "
                ...
                + "    WHERE d.region = 'US' AND e.age > 30",
            employees(
                employee(1, "Alice", "1"), employee(2, "Hank", "1"), employee(3, "Mike", "2")),
            departments(department(1, "1", "AWS"), department(2, "2", "Retail"))),
        hits(
            hit(MatcherUtils.kv("d.name", "AWS"), MatcherUtils.kv("e.lastname", "Alice")),
            hit(MatcherUtils.kv("d.name", "AWS"), MatcherUtils.kv("e.lastname", "Hank")),
            hit(MatcherUtils.kv("d.name", "Retail"), MatcherUtils.kv("e.lastname", "Mike"))));
  }
    ...
    MatcherAssert.assertThat(
        query(
            "SELECT d.name, e.lastname FROM employee e "
                ...
                + "    WHERE d.region = 'US' AND e.age > 30",
            employees(
                employee(1, "Alice", "1"), employee(2, "Hank", null), employee(3, "Mike", "2")),
            departments(department(1, "1", "AWS"), department(2, null, "Retail"))),
        hits(hit(MatcherUtils.kv("d.name", "AWS"), MatcherUtils.kv("e.lastname", "Alice"))));
  }
    ...
    MatcherAssert.assertThat(
        query(
            "SELECT d.name, e.name FROM employee e "
                + "  JOIN department d ON d.id = e.departmentId "
                + "    WHERE d.region = 'US' AND e.age > 30",
            employees(alice, hank),
            departments(department(1, "1", "AWS"))),
        hits(hit(MatcherUtils.kv("d.name", "AWS"), MatcherUtils.kv("e.name", "Alice Alice"))));
  }
  ...
  public void simpleJoinWithAliasInSelect() {
    MatcherAssert.assertThat(
        query(
            ...
            employees(employee(1, "Alice", "2"), employee(2, "Hank", "3")),
            departments(department(1, "1", "AWS"), department(2, "2", "Retail"))),
        hits(hit(MatcherUtils.kv("dname", "Retail"), MatcherUtils.kv("ename", "Alice"))));
  }
  ...
  public void simpleLeftJoinWithoutMatchInLeft() {
    MatcherAssert.assertThat(
        query(
            ...
            departments(department(1, "1", "AWS"))),
        hits(
            hit(MatcherUtils.kv("d.name", null), MatcherUtils.kv("e.lastname", "Alice")),
            hit(MatcherUtils.kv("d.name", null), MatcherUtils.kv("e.lastname", "Hank"))));
  }
    ...
    MatcherAssert.assertThat(
        query(
            "SELECT d.name, e.lastname FROM employee e "
                + "  LEFT JOIN department d ON d.id = e.departmentId "
                + "    WHERE d.region = 'US' AND e.age > 30",
            employees(employee(1, "Alice", "1"), employee(2, "Hank", "2")),
            departments(department(1, "1", "AWS"))),
        hits(
            hit(MatcherUtils.kv("d.name", "AWS"), MatcherUtils.kv("e.lastname", "Alice")),
            hit(MatcherUtils.kv("d.name", null), MatcherUtils.kv("e.lastname", "Hank"))));
  ...
  public void simpleQueryWithTotalLimit() {
    MatcherAssert.assertThat(
        query(
            ...
            employees(employee(1, "Alice", "1"), employee(2, "Hank", "2")),
            departments(department(1, "1", "AWS"), department(1, "2", "Retail"))),
        hits(hit(MatcherUtils.kv("d.name", "AWS"), MatcherUtils.kv("e.lastname", "Alice"))));
  }
  ...
  public void simpleQueryWithOrderBy() {
    MatcherAssert.assertThat(
        ...
        MatcherUtils.hitsInOrder(
            hit(MatcherUtils.kv("d.name", "Retail"), MatcherUtils.kv("e.lastname", "Alice")),
            hit(MatcherUtils.kv("d.name", "AWS"), MatcherUtils.kv("e.lastname", "Allen")),
            hit(MatcherUtils.kv("d.name", "Retail"), MatcherUtils.kv("e.lastname", "Ellis")),
            hit(MatcherUtils.kv("d.name", "Retail"), MatcherUtils.kv("e.lastname", "Frank")),
            hit(MatcherUtils.kv("d.name", "AWS"), MatcherUtils.kv("e.lastname", "Hank"))));
  }
  ...
  public void simpleQueryWithLeftJoinAndOrderByMultipleColumnsFromOneTableInDesc() {
    MatcherAssert.assertThat(
        query(
            ...
            departments(department(1, "1", "AWS"), department(2, "2", "Retail"))),
        MatcherUtils.hitsInOrder(
            hit(MatcherUtils.kv("id", null), MatcherUtils.kv("lastname", "Gary")),
            hit(MatcherUtils.kv("id", null), MatcherUtils.kv("lastname", "Frank")),
            hit(MatcherUtils.kv("id", "2"), MatcherUtils.kv("lastname", "Ellis")),
            hit(MatcherUtils.kv("id", "2"), MatcherUtils.kv("lastname", "Alice")),
            hit(MatcherUtils.kv("id", "1"), MatcherUtils.kv("lastname", "Hank")),
            hit(MatcherUtils.kv("id", "1"), MatcherUtils.kv("lastname", "Allen"))));
  }
  ...
  public void simpleCrossJoin() {
    MatcherAssert.assertThat(
        query(
            ...
            departments(department(1, "1", "AWS"), department(2, "2", "Retail"))),
        hits(
            hit(MatcherUtils.kv("dname", "AWS"), MatcherUtils.kv("ename", "Alice")),
            hit(MatcherUtils.kv("dname", "AWS"), MatcherUtils.kv("ename", "Hank")),
            hit(MatcherUtils.kv("dname", "Retail"), MatcherUtils.kv("ename", "Alice")),
            hit(MatcherUtils.kv("dname", "Retail"), MatcherUtils.kv("ename", "Hank"))));
  }
    ...
    MatcherAssert.assertThat(
        query(
            "SELECT /*! HASH_WITH_TERMS_FILTER*/ "
                + // Be careful that no space between ...FILTER and */
            ...
            employees(
                ...
                employee(4, "Dell", "1"),
                employee(5, "Dell", "4")),
            departments(department(1, "1", "Johnson"), department(1, "4", "Dell"))),
        hits(
            hit(MatcherUtils.kv("e.lastname", "Johnson"), MatcherUtils.kv("d.id", "1")),
            hit(MatcherUtils.kv("e.lastname", "Dell"), MatcherUtils.kv("d.id", "4"))));
  }
    ...
    MatcherAssert.assertThat(
        query(
            "SELECT d.name, e.lastname, d.id "
                ...
                + "        WHERE d.region = 'US' AND e.age > 30",
            employees(employee(1, "Dell", "1"), employee(2, "Hank", "1")),
            departments(department(1, "1", "Dell"))),
        hits(
            hit(
  ...
  public void complexJoinWithOrConditions() {
    MatcherAssert.assertThat(
        query(
            ...
            employees(
                employee(1, "Alice", "1"), employee(2, "Dell", "2"), employee(3, "Hank", "3")),
            departments(department(1, "1", "Dell"), department(2, "4", "AWS"))),
        hits(
            hit(MatcherUtils.kv("d.name", "Dell"), MatcherUtils.kv("e.lastname", "Alice")),
            hit(MatcherUtils.kv("d.name", "Dell"), MatcherUtils.kv("e.lastname", "Dell"))));
  }
  ...
  public void complexJoinWithOrConditionsDuplicate() {
    MatcherAssert.assertThat(
        query(
            ...
            departments(department(1, "1", "Dell"), department(2, "4", "AWS"))),
        hits(hit(MatcherUtils.kv("d.name", "Dell"), MatcherUtils.kv("e.departmentId", "1"))));
  }
    ...
    MatcherAssert.assertThat(
        query(
            ...
            departments(
                ...
                department(2, "4", "AWS"))),
        hits(hit(MatcherUtils.kv("d.name", "Dell"), MatcherUtils.kv("e.lastname", "Alice"))));
  }
}
