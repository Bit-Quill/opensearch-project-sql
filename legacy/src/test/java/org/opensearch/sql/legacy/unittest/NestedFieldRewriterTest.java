...
public class NestedFieldRewriterTest {
  ...
  public void selectAllWithCondition() {
    same(
        ...
        query(
            "SELECT *, nested(employees.*, 'employees') FROM team WHERE nested(employees.age, 'employees') = 26"));
  }
  ...
  public void mixedWithObjectType() {
    same(
        ...
        query(
            "SELECT region FROM team WHERE nested(employees.age, 'employees') > 30 OR manager.age = 50"));
  }
  ...
  public void groupBy() {
    same(
        ...
        query(
            "SELECT nested(employees.firstname, 'employees'), COUNT(*) FROM team GROUP BY nested(employees.firstname, 'employees')"));
  }
  ...
  public void multipleFieldsInFrom() {
    same(
        query(
            "SELECT region FROM team/test t, t.manager m, t.employees e WHERE m.age = 30 AND e.age = 26"),
        query(
            "SELECT region FROM team/test WHERE nested(manager.age, 'manager') = 30 "
  ...
  public void unionAll() {
    ...
    same(
        query(
            "SELECT region FROM team t, t.employees e WHERE e.age = 26 "
                + "UNION ALL "
                + "SELECT region FROM team t, t.employees e WHERE e.firstname = 'John'"),
        query(
            "SELECT region FROM team WHERE nested(employees.age, 'employees') = 26 "
                + "UNION ALL "
  ...
  public void subQuery() {
    ...
    same(
        query(
            "SELECT region FROM team t, t.employees e "
                + "  WHERE e.age IN "
  ...
  public void subQueryWitSameAlias() {
    ...
    same(
        query(
            "SELECT name FROM team t, t.employees e "
                + "  WHERE e.age IN "
  ...
  public void multiCondition() {
    same(
        query(
            "SELECT e.name FROM employee as e, e.projects as p WHERE p.year = 2016 and p.name LIKE 'security'"),
        query(
            "SELECT name FROM employee WHERE nested('projects', projects.year = 2016 AND projects.name LIKE 'security')"));
  }
   ...
   *
   * <p>1) MySqlSelectQueryBlock.equals() doesn't call super.equals(). But select items, from, where
   * and group by are all held by parent class SQLSelectQueryBlock.
   *
   * <p>2) SQLSelectGroupByClause doesn't implement equals() at all.. MySqlSelectGroupByExpr
   * compares identity of expression..
   *
   * <p>3) MySqlUnionQuery doesn't implement equals() at all
   */
  ...
  private void assertQuery(SQLSelect expected, SQLSelect actual) {
    ...
    if (actualQuery instanceof SQLSelectQueryBlock) {
      assertQueryBlock((SQLSelectQueryBlock) expectedQuery, (SQLSelectQueryBlock) actualQuery);
  ...
  /**
   * Walk through extra rewrite logic if NOT found "nested" in SQL query statement. Otherwise return
   * as before so that original logic be compared with result of rewrite.
   *
   * @param sql Test sql
