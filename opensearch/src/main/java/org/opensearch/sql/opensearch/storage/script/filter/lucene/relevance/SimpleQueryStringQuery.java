...
public class SimpleQueryStringQuery extends RelevanceQuery<SimpleQueryStringBuilder> {
  /**
   *  Default constructor for SimpleQueryStringQuery configures how RelevanceQuery.build() handles
   * named arguments.
   */
  ...
  public QueryBuilder build(FunctionExpression func) {
    ...
    SimpleQueryStringBuilder queryBuilder =
        createQueryBuilder(null,query.getValue().valueOf(null).stringValue())
