...
public class LegacyOpenDistroSettings {
  ...
  public static final Setting<Boolean> SQL_ENABLED_SETTING =
      Setting.boolSetting(
  ...
  public static final Setting<Integer> SQL_QUERY_SLOWLOG_SETTING =
      Setting.intSetting(
  ...
  public static final Setting<TimeValue> SQL_CURSOR_KEEPALIVE_SETTING =
  ...
  public static final Setting<Long> METRICS_ROLLING_WINDOW_SETTING =
      Setting.longSetting(
  ...
  public static final Setting<Long> METRICS_ROLLING_INTERVAL_SETTING =
      Setting.longSetting(
  ...
  public static final Setting<Boolean> PPL_ENABLED_SETTING =
      Setting.boolSetting(
  ...
  public static final Setting<ByteSizeValue> PPL_QUERY_MEMORY_LIMIT_SETTING =
  ...
  /** Deprecated and will be removed then. From OpenSearch 1.0, the new engine is always enabled. */
  public static final Setting<Boolean> SQL_NEW_ENGINE_ENABLED_SETTING =
      Setting.boolSetting(
  ...
  /**
   * Deprecated and will be removed then. From OpenSearch 1.0, the query analysis in legacy engine
   * is disabled.
   */
  public static final Setting<Boolean> QUERY_ANALYSIS_ENABLED_SETTING =
      Setting.boolSetting(
  ...
  /**
   * Deprecated and will be removed then. From OpenSearch 1.0, the query analysis suggestion in
   * legacy engine is disabled.
   */
  ...
  /**
   * Deprecated and will be removed then. From OpenSearch 1.0, the query analysis threshold in
   * legacy engine is disabled.
   */
  ...
  /**
   * Deprecated and will be removed then. From OpenSearch 1.0, the query response format is default
   * to JDBC format.
   */
  ...
  /**
   * Deprecated and will be removed then. From OpenSearch 1.0, the cursor feature is enabled by
   * default.
   */
  ...
  /**
   * Deprecated and will be removed then. From OpenSearch 1.0, the fetch_size in query body will
   * decide whether create the cursor context. No cursor will be created if the fetch_size = 0.
   */
