...
class OpenSearchExprValueFactoryTest {
  ...
  private static final Map<String, OpenSearchDataType> MAPPING =
      new ImmutableMap.Builder<String, OpenSearchDataType>()
          ...
          .put("datetimeV", OpenSearchDateType.create("", OpenSearchDataType.MappingType.Date))
          .put("timeV", OpenSearchDateType.create("", OpenSearchDataType.MappingType.Date))
          .put("timestampV", OpenSearchDateType.create("", OpenSearchDataType.MappingType.Date))
