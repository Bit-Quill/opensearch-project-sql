...
dateAndTimeFunctionBase
    : ADDDATE | CONVERT_TZ | DATE | DATETIME | DATE_ADD | DATE_SUB | DAY | DAYNAME | DAYOFMONTH | DAYOFWEEK
    | DAYOFYEAR | FROM_DAYS | HOUR | MICROSECOND | MINUTE | MONTH | MONTHNAME | QUARTER | SECOND | SUBDATE
    | TIME | TIME_TO_SEC | TIMESTAMP | TO_DAYS | YEAR | WEEK | DATE_FORMAT | NOW | CURDATE | CURRENT_DATE
    | CURTIME | CURRENT_TIME | LOCALTIME | CURRENT_TIMESTAMP | LOCALTIMESTAMP | SYSDATE | UTC_TIMESTAMP
    | UTC_DATE | UTC_TIME | MAKETIME | MAKEDATE
    ;
