...
dateAndTimeFunctionBase
    : ADDDATE | CONVERT_TZ | DATE | DATETIME | DATE_ADD | DATE_FORMAT | DATE_SUB | DAY | DAYNAME
    | DAYOFMONTH | DAYOFWEEK | DAYOFYEAR | FROM_DAYS | HOUR | MAKEDATE | MAKETIME | MICROSECOND
    | MINUTE | MONTH | MONTHNAME | QUARTER | SECOND | SUBDATE | SYSDATE | TIME | TIME_TO_SEC
    | TIMESTAMP | TO_DAYS | UTC_DATE | UTC_TIME | UTC_DATETIME | WEEK | YEAR
    ;
