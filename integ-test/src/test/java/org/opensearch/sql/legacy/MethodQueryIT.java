...
public class MethodQueryIT extends SQLIntegTestCase {
  ...
  /**
   * query "query" : { query_string" : { "query" : "address:880 Holmes Lane" } }
   *
   * @throws IOException
   */
  @Test
  ...
  /**
   * matchQuery "query" : { "match" : { "address" : { "query" : "880 Holmes Lane", "type" :
   * "boolean" } } }
   *
   * @throws IOException
   */
  ...
  /**
   * matchQuery { "query": { "bool": { "must": { "bool": { "should": [ { "constant_score": {
   * "query": { "match": { "address": { "query": "Lane", "type": "boolean" } } }, "boost": 100 } },
   * { "constant_score": { "query": { "match": { "address": { "query": "Street", "type": "boolean" }
   * } }, "boost": 0.5 } } ] } } } } }
   *
   * @throws IOException
   */
  @Test
  @Ignore(
      "score query no longer maps to constant_score in the V2 engine - @see org.opensearch.sql.sql.ScoreQueryIT")
  ...
  /**
   * wildcardQuery l*e means leae ltae ... "wildcard": { "address" : { "wildcard" : "l*e" } }
   *
   * @throws IOException
   */
  @Test
  ...
  /**
   * matchPhraseQuery "address" : { "query" : "671 Bristol Street", "type" : "phrase" }
   *
   * @throws IOException
   */
  @Test
