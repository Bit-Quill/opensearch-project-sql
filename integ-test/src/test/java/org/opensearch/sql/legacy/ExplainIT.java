...
public class ExplainIT extends SQLIntegTestCase {
  ...
  public void searchSanity() throws IOException {
    ...
    String expectedOutputFilePath =
        TestUtils.getResourceFilePath("src/test/resources/expectedOutput/search_explain.json");
  ...
  public void aggregationQuery() throws IOException {
    ...
    String result =
        explainQuery(
            String.format(
                "SELECT address, CASE WHEN gender='0' then 'aaa' else 'bbb'end a2345,"
  ...
  public void explainScriptValue() throws IOException {
    ...
    String expectedOutputFilePath =
        TestUtils.getResourceFilePath("src/test/resources/expectedOutput/script_value.json");
    String expectedOutput =
        Files.toString(new File(expectedOutputFilePath), StandardCharsets.UTF_8)
            .replaceAll("\r", "");
  ...
  public void betweenScriptValue() throws IOException {
    ...
    String expectedOutputFilePath =
        TestUtils.getResourceFilePath("src/test/resources/expectedOutput/between_query.json");
    String expectedOutput =
        Files.toString(new File(expectedOutputFilePath), StandardCharsets.UTF_8)
            .replaceAll("\r", "");
  ...
  public void multiMatchQuery() throws IOException {
    ...
    String expectedOutputFilePath =
        TestUtils.getResourceFilePath("src/test/resources/expectedOutput/multi_match_query.json");
    String expectedOutput =
        Files.toString(new File(expectedOutputFilePath), StandardCharsets.UTF_8)
            .replaceAll("\r", "");
  ...
  public void termsIncludeExcludeExplainTest() throws IOException {
    ...
    String result =
        explainQuery(
            queryPrefix
                + " terms('field'='correspond_brand_name','size'='10',"
  ...
  public void explainNLJoin() throws IOException {
    ...
    String query =
        "SELECT /*! USE_NL*/ a.firstname ,a.lastname , a.gender ,d.dog_name  FROM "
            + TEST_INDEX_PEOPLE
            + "/people a JOIN "
            + TEST_INDEX_DOG
