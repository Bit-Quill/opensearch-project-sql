...
@Ignore("Count in select is not pushed down and non-push down operations are not supported with json format yet")
public class HavingIT extends SQLIntegTestCase {
  ...
  public void equalsTo() throws IOException {
    var a = query(SELECT_FROM_WHERE_GROUP_BY + "HAVING cnt = 2");
    assertThat(
