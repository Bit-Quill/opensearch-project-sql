...
public class DateTimeImplementationIT extends SQLIntegTestCase {
  ...
  public void inRangeZeroToPositive() throws IOException {
    ...
    verifySchema(result,
        schema("DATETIME('2008-12-25 05:30:00+00:00', '+01:00')", null, "timestamp"));
  ...
  public void inRangeNegativeToPositive() throws IOException {
    ...
    verifySchema(result,
        schema("DATETIME('2008-12-25 05:30:00-05:00', '+05:00')", null, "timestamp"));
  ...
  public void inRangeTwentyHourOffset() throws IOException {
    ...
    verifySchema(result,
        schema("DATETIME('2004-02-28 23:00:00-10:00', '+10:00')", null, "timestamp"));
  ...
  public void inRangeYearChange() throws IOException {
    ...
    verifySchema(result,
        schema("DATETIME('2008-01-01 02:00:00+10:00', '-10:00')", null, "timestamp"));
  ...
  public void inRangeZeroNoToTZ() throws IOException {
    ...
    verifySchema(result,
        schema("DATETIME('2008-01-01 02:00:00+10:00')", null, "timestamp"));
  ...
  public void inRangeZeroNoTZ() throws IOException {
    ...
    verifySchema(result,
        schema("DATETIME('2008-01-01 02:00:00')", null, "timestamp"));
    verifyDataRows(result, rows("2008-01-01 02:00:00"));
  }
  ...
  public void inRangeZeroDayConvert() throws IOException {
    ...
    verifySchema(result,
        schema("DATETIME('2008-01-01 02:00:00+12:00', '-12:00')", null, "timestamp"));
  ...
  public void inRangeJustInRangeNegative() throws IOException {
    ...
    verifySchema(result,
        schema("DATETIME('2008-01-01 02:00:00+10:00', '-13:59')", null, "timestamp"));
  ...
  public void inRangeJustInRangePositive() throws IOException {
    ...
    verifySchema(result,
        schema("DATETIME('2008-01-01 02:00:00+14:00', '-10:00')", null, "timestamp"));
    verifyDataRows(result, rows("2007-12-31 02:00:00"));
  }
  ...
  public void nullField3Under() throws IOException {
    ...
    verifySchema(result,
        schema("DATETIME('2008-01-01 02:00:00+10:00', '-14:01')", null, "timestamp"));
  ...
  public void nullField1Over() throws IOException {
    ...
    verifySchema(result,
        schema("DATETIME('2008-01-01 02:00:00+14:01', '-10:00')", null, "timestamp"));
    verifyDataRows(result, rows(new Object[]{null}));
  }
  ...
  public void nullDateTimeInvalidDateValueFebruary() throws IOException {
    ...
    verifySchema(result,
        schema("DATETIME('2021-02-30 10:00:00')", null, "timestamp"));
    verifyDataRows(result, rows(new Object[]{null}));
  }
  ...
  public void nullDateTimeInvalidDateValueApril() throws IOException {
    ...
    verifySchema(result,
        schema("DATETIME('2021-04-31 10:00:00')", null, "timestamp"));
    verifyDataRows(result, rows(new Object[]{null}));
  }
  ...
  public void nullDateTimeInvalidDateValueMonth() throws IOException {
    ...
    verifySchema(result,
        schema("DATETIME('2021-13-03 10:00:00')", null, "timestamp"));
    verifyDataRows(result, rows(new Object[]{null}));
  }
}
