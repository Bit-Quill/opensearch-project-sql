...
public class DateTimeFunctionIT extends SQLIntegTestCase {
  ...
  public void testAddDateWithInterval() throws IOException {
    ...
    verifySchema(result,
        schema("adddate(date('2020-09-16'), interval 1 hour)", null, "timestamp"));
    verifyDataRows(result, rows("2020-09-16 01:00:00"));

    result = executeQuery("select adddate(TIME('07:40:00'), interval 1 day)");
    verifySchema(result,
        schema("adddate(TIME('07:40:00'), interval 1 day)", null, "timestamp"));
    verifyDataRows(result,
    ...
    verifySchema(result,
        schema("adddate(TIME('07:40:00'), interval 1 hour)", null, "timestamp"));
    verifyDataRows(result,
  ...
  public void testDateAdd() throws IOException {
    ...
    verifySchema(result,
        schema("date_add(date('2020-09-16'), interval 1 day)", null, "timestamp"));
    verifyDataRows(result, rows("2020-09-17 00:00:00"));

    result = executeQuery("select date_add(date('2020-09-16'), interval 1 hour)");
    verifySchema(result,
        schema("date_add(date('2020-09-16'), interval 1 hour)", null, "timestamp"));
    verifyDataRows(result, rows("2020-09-16 01:00:00"));

    result = executeQuery("select date_add(TIME('07:40:00'), interval 1 day)");
    verifySchema(result,
        schema("date_add(TIME('07:40:00'), interval 1 day)", null, "timestamp"));
    verifyDataRows(result,
        rows(LocalDate.now().plusDays(1).atTime(LocalTime.of(7, 40)).atZone(systemTz.toZoneId())
            .format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))));
    ...
    verifySchema(result,
        schema("date_add(TIME('07:40:00'), interval 1 hour)", null, "timestamp"));
    verifyDataRows(result,
        rows(LocalDate.now().atTime(LocalTime.of(8, 40)).atZone(systemTz.toZoneId())
            .format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))));
    ...
    verifySchema(result,
        schema("DATE_ADD(birthdate, INTERVAL 1 YEAR)", null, "timestamp"));
    verifyDataRows(result,
  ...
  public void testDateSub() throws IOException {
    ...
    verifySchema(result,
        schema("date_sub(TIME('07:40:00'), interval 1 hour)", null, "timestamp"));
    verifyDataRows(result,
  ...
  public void testExtractWithDatetime() throws IOException {
    JSONObject datetimeResult = executeQuery(
        String.format(
            "SELECT extract(DAY_SECOND FROM timestamp(cast(datetime0 AS STRING))) FROM %s LIMIT 1",
            TEST_INDEX_CALCS));
  ...
  public void testMinuteFunctionAliasesReturnTheSameResults() throws IOException {
    ...
    result2 = executeQuery(String.format(
        "SELECT minute_of_hour(timestamp(CAST(time0 AS STRING))) FROM %s", TEST_INDEX_CALCS));
    result1.getJSONArray("datarows").similar(result2.getJSONArray("datarows"));
  ...
  public void testMonthAlternateSyntaxesReturnTheSameResults() throws IOException {
    ...
    result2 = executeQuery(String.format(
        "SELECT month_of_year(timestamp(CAST(time0 AS STRING))) FROM %s", TEST_INDEX_CALCS));
    result1.getJSONArray("datarows").similar(result2.getJSONArray("datarows"));
  ...
  public void testSecondFunctionAliasesReturnTheSameResults() throws IOException {
    ...
    result2 = executeQuery(String.format(
        "SELECT second_of_minute(timestamp(CAST(time0 AS STRING))) FROM %s", TEST_INDEX_CALCS));
    result1.getJSONArray("datarows").similar(result2.getJSONArray("datarows"));
  ...
  public void testSubDateWithDays() throws IOException {
    ...
    verifySchema(result,
        schema("subdate(timestamp('2020-09-16 17:30:00'), 1)", null, "timestamp"));
    verifyDataRows(result, rows("2020-09-15 17:30:00"));
  ...
  public void testSubDateWithInterval() throws IOException {
    ...
    verifySchema(result,
        schema("subdate(date('2020-09-16'), interval 1 day)", null, "timestamp"));
    verifyDataRows(result, rows("2020-09-15 00:00:00"));

    result = executeQuery("select subdate(date('2020-09-16'), interval 1 hour)");
    verifySchema(result,
        schema("subdate(date('2020-09-16'), interval 1 hour)", null, "timestamp"));
    verifyDataRows(result, rows("2020-09-15 23:00:00"));

    result = executeQuery("select subdate(TIME('07:40:00'), interval 1 day)");
    verifySchema(result,
        schema("subdate(TIME('07:40:00'), interval 1 day)", null, "timestamp"));
    verifyDataRows(result,
        rows(LocalDate.now().plusDays(-1).atTime(LocalTime.of(7, 40)).atZone(systemTz.toZoneId())
            .format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))));
    ...
    verifySchema(result,
        schema("subdate(TIME('07:40:00'), interval 1 hour)", null, "timestamp"));
    verifyDataRows(result,
        rows(LocalDate.now().atTime(LocalTime.of(6, 40)).atZone(systemTz.toZoneId())
            .format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))));
  }
  ...
  public void testToSeconds() throws IOException {
    ...
    result = executeQuery(
        String.format("SELECT to_seconds(timestamp(cast(datetime0 AS string))) FROM %s LIMIT 2", TEST_INDEX_CALCS));
  ...
  public void testAddTime() throws IOException {
    var result = executeQuery("SELECT"
        ...
        + " ADDTIME(TIMESTAMP('1999-12-31 15:42:13'), TIMESTAMP('1961-04-12 09:07:00')) AS `'15:42:13' + '09:07:00'`");
    verifySchema(result,
        ...
        schema("ADDTIME(DATE('2004-01-01'), TIME('23:59:59'))", "'2004-01-01' + '23:59:59'", "timestamp"),
        schema("ADDTIME(TIME('10:20:30'), TIME('00:05:42'))", "'10:20:30' + '00:05:42'", "time"),
        schema("ADDTIME(TIMESTAMP('1999-12-31 15:42:13'), TIMESTAMP('1961-04-12 09:07:00'))", "'15:42:13' + '09:07:00'", "timestamp"));
  ...
  public void testSubTime() throws IOException {
    var result = executeQuery("SELECT"
        ...
        + " SUBTIME(TIMESTAMP('1999-12-31 15:42:13'), TIMESTAMP('1961-04-12 09:07:00')) AS `'15:42:13' - '09:07:00'`");
    verifySchema(result,
        ...
        schema("SUBTIME(DATE('2004-01-01'), TIME('23:59:59'))", "'2004-01-01' - '23:59:59'", "timestamp"),
        schema("SUBTIME(TIME('10:20:30'), TIME('00:05:42'))", "'10:20:30' - '00:05:42'", "time"),
        schema("SUBTIME(TIMESTAMP('1999-12-31 15:42:13'), TIMESTAMP('1961-04-12 09:07:00'))", "'15:42:13' - '09:07:00'", "timestamp"));
  ...
  public void testDateDiff() throws IOException {
    var result = executeQuery("SELECT"
        ...
        + " DATEDIFF(TIMESTAMP('2004-01-01 00:00:00'), TIMESTAMP('2002-02-01 14:25:30')) AS `'2004-01-01' - '2002-02-01'`,"
    ...
    verifySchema(result,
        ...
        schema("DATEDIFF(TIMESTAMP('2004-01-01 00:00:00'), TIMESTAMP('2002-02-01 14:25:30'))", "'2004-01-01' - '2002-02-01'", "long"),
