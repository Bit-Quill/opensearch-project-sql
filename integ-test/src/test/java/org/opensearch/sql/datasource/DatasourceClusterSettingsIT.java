...
public class DatasourceClusterSettingsIT extends PPLIntegTestCase {
  ...
  public void testGetDatasourceClusterSettings() throws IOException {
    ...
    assertThat(
        clusterSettings.query("/defaults/plugins.query.datasources.encryption.masterkey"),
        equalTo(null));
  }
  ...
  public void testPutDatasourceClusterSettings() throws IOException {
    ...
    assertThat(
        resp.query("/error/root_cause/0/reason"),
        equalTo(
            "final persistent setting [plugins.query.datasources.encryption.masterkey], not updateable"));
