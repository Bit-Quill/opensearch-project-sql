...
public class DateTimeFunctionIT extends PPLIntegTestCase {
  ...
  public void testMicrosecond() throws IOException {
    JSONObject result =
        executeQuery(
            String.format(
                "source=%s | eval f =  microsecond(timestamp('2020-09-16 17:30:00.123456')) | fields f",
                TEST_INDEX_DATE));
    verifySchema(result, schema("f", null, "integer"));
    ...
    result =
        executeQuery(
            String.format(
                "source=%s | eval f =  microsecond(timestamp('2020-09-16 17:30:00.1234')) | fields f",
                TEST_INDEX_DATE));
    verifySchema(result, schema("f", null, "integer"));
  ...
  public void testSecond_of_minute() throws IOException {
    JSONObject result =
        executeQuery(
            String.format(
                "source=%s | eval f =  second_of_minute(timestamp('2020-09-16 17:30:00')) | fields f",
                TEST_INDEX_DATE));
    verifySchema(result, schema("f", null, "integer"));
    verifySome(result.getJSONArray("datarows"), rows(0));
  ...
  public void testMakeTime() throws IOException {
    var result =
        executeQuery(
            String.format(
                "source=%s | eval f1 = MAKETIME(20, 30, 40), f2 = MAKETIME(20.2, 49.5, 42.100502) | fields f1, f2",
                TEST_INDEX_DATE));
  ...
  public void testMakeDate() throws IOException {
    var result =
        executeQuery(
            String.format(
                "source=%s | eval f1 = MAKEDATE(1945, 5.9), f2 = MAKEDATE(1984, 1984) | fields f1, f2",
                TEST_INDEX_DATE));
        ...
        executeQuery(
            String.format(
                "source=%s | eval"
                    ...
                    + " | fields `'2008-12-12' + 0`, `'23:59:59' + 0`, `'2004-01-01' + '23:59:59'`, `'10:20:30' + '00:05:42'`, `'15:42:13' + '09:07:00'`",
                TEST_INDEX_DATE));
    verifySchema(
        result,
  ...
  public void testPeriodAdd() throws IOException {
    var result =
        executeQuery(
            String.format(
                "source=%s | eval f1 = PERIOD_ADD(200801, 2), f2 = PERIOD_ADD(200801, -12) | fields f1, f2",
                TEST_INDEX_DATE));
  ...
  public void testPeriodDiff() throws IOException {
    var result =
        executeQuery(
            String.format(
                "source=%s | eval f1 = PERIOD_DIFF(200802, 200703), f2 = PERIOD_DIFF(200802, 201003) | fields f1, f2",
                TEST_INDEX_DATE));
    verifySchema(result, schema("f1", null, "integer"), schema("f2", null, "integer"));
        ...
        executeQuery(
            String.format(
                "source=%s | eval"
                    ...
                    + " | fields `'2000-01-02' - '2000-01-01'`, `'2001-02-01' - '2004-01-01'`, `'2004-01-01' - '2002-02-01'`, `today - today`",
                TEST_INDEX_DATE));
    verifySchema(
        result,
