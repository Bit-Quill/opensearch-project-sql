...
public class DateTimeImplementationIT extends PPLIntegTestCase {
  ...
  public void inRangeZeroToStringTZ() throws IOException {
    JSONObject result = executeQuery(
        String.format("source=%s | eval f = DATETIME('2008-12-25 05:30:00+00:00', 'America/Los_Angeles') | fields f",
            TEST_INDEX_DATE));
  ...
  public void inRangeZeroToPositive() throws IOException {
    JSONObject result = executeQuery(
        String.format("source=%s | eval f = DATETIME('2008-12-25 05:30:00+00:00', '+01:00') | fields f",
            TEST_INDEX_DATE));
    verifySchema(result, schema("f", null, "datetime"));
  ...
  public void inRangeNegativeToPositive() throws IOException {
    JSONObject result = executeQuery(
        String.format("source=%s | eval f = DATETIME('2008-12-25 05:30:00-05:00', '+05:00') | fields f",
            TEST_INDEX_DATE));
    verifySchema(result, schema("f", null, "datetime"));
  ...
  public void inRangeTwentyHourOffset() throws IOException {
    JSONObject result = executeQuery(
        String.format("source=%s | eval f = DATETIME('2004-02-28 23:00:00-10:00', '+10:00') | fields f",
            TEST_INDEX_DATE));
    verifySchema(result, schema("f", null, "datetime"));
  ...
  public void inRangeYearChange() throws IOException {
    JSONObject result = executeQuery(
        String.format("source=%s | eval f = DATETIME('2008-01-01 02:00:00+10:00', '-10:00') | fields f",
            TEST_INDEX_DATE));
    verifySchema(result, schema("f", null, "datetime"));
  ...
  public void inRangeZeroToMax() throws IOException {
    JSONObject result = executeQuery(
        String.format("source=%s | eval f = DATETIME('2008-12-25 05:30:00+00:00', '+14:00') | fields f",
            TEST_INDEX_DATE));
    verifySchema(result, schema("f", null, "datetime"));
  ...
  public void inRangeNoToTZ() throws IOException {
    JSONObject result = executeQuery(
        String.format("source=%s | eval f = DATETIME('2008-01-01 02:00:00+10:00') | fields f", TEST_INDEX_DATE));
    verifySchema(result, schema("f", null, "datetime"));
  ...
  public void inRangeNoTZ() throws IOException {
    JSONObject result = executeQuery(
        String.format("source=%s | eval f = DATETIME('2008-01-01 02:00:00') | fields f", TEST_INDEX_DATE));
    verifySchema(result, schema("f", null, "datetime"));
    verifySome(result.getJSONArray("datarows"), rows("2008-01-01 02:00:00"));
  }
  ...
  public void nullDateTimeInvalidDateValueFebruary() throws IOException {
    JSONObject result = executeQuery(
        String.format("source=%s | eval f = DATETIME('2021-02-30 10:00:00') | fields f", TEST_INDEX_DATE));
    verifySchema(result, schema("f", null, "datetime"));
    verifySome(result.getJSONArray("datarows"), rows(new Object[]{null}));
  }
  ...
  public void nullDateTimeInvalidDateValueApril() throws IOException {
    JSONObject result = executeQuery(
        String.format("source=%s | eval f = DATETIME('2021-04-31 10:00:00') | fields f", TEST_INDEX_DATE));
    verifySchema(result, schema("f", null, "datetime"));
    verifySome(result.getJSONArray("datarows"), rows(new Object[]{null}));
  }
  ...
  public void nullDateTimeInvalidDateValueMonth() throws IOException {
    JSONObject result = executeQuery(
        String.format("source=%s | eval f = DATETIME('2021-13-03 10:00:00') | fields f", TEST_INDEX_DATE));
    verifySchema(result, schema("f", null, "datetime"));
    verifySome(result.getJSONArray("datarows"), rows(new Object[]{null}));
  }
}
