...
Example::
  ...
  os> SELECT CONVERT_TZ("2010-10-10 10:10:10", "+01:00", "-10:00"), CONVERT_TZ("test", "+01:00", "-10:00"), CONVERT_TZ("2010-10-10 10:10:10", "test", "-10:00"), CONVERT_TZ("2010-10-10 10:10:10", "+01:00", "-14:00"), CONVERT_TZ("2010-10-10 10:10:10", "+00:00", "+00:00")
    fetched rows / total rows = 1/1
    +---------------------------------------------------------+------------------------------------------+-------------------------------------------------------+---------------------------------------------------------+---------------------------------------------------------+
    | CONVERT_TZ("2010-10-10 10:10:10", "+01:00", "-10:00")   | CONVERT_TZ("test", "+01:00", "-10:00")   | CONVERT_TZ("2010-10-10 10:10:10", "test", "-10:00")   | CONVERT_TZ("2010-10-10 10:10:10", "+01:00", "-14:00")   | CONVERT_TZ("2010-10-10 10:10:10", "+00:00", "+00:00")   |
    |---------------------------------------------------------+------------------------------------------+-------------------------------------------------------+---------------------------------------------------------+---------------------------------------------------------|
    | 2010-10-09 23:10:10                                     | null                                     | null                                                  | null                                                    | 2010-10-10 10:10:10                                     |
    +---------------------------------------------------------+------------------------------------------+-------------------------------------------------------+---------------------------------------------------------+---------------------------------------------------------+
...
Example::
    ...
    os> SELECT DATETIME('2008-12-25 05:30:00+00:00', 'America/Los_Angeles'), DATETIME('2004-02-28 23:00:00-10:00', '+10:00'), DATETIME('2008-01-01 02:00:00', '-14:00')
    fetched rows / total rows = 1/1
    +----------------------------------------------------------------+---------------------------------------------------+---------------------------------------------+
