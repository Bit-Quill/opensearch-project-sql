...
Example::
    ...
    os> SELECT DATE('2020-08-26'), DATE(TIMESTAMP('2020-08-26 13:49:00')), DATE('2020-08-26 13:49:00')
    fetched rows / total rows = 1/1
    +----------------------+------------------------------------------+-------------------------------+
...
Example::
    ...
    os> SELECT TIME('13:49:00'), TIME(TIMESTAMP('2020-08-26 13:49:00')), TIME('2020-08-26 13:49:00')
    fetched rows / total rows = 1/1
    +--------------------+------------------------------------------+-------------------------------+
