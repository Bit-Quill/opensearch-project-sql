...
Example::
    ...
    os> source=people | eval `DATE('2020-08-26')` = DATE('2020-08-26'), `DATE(TIMESTAMP('2020-08-26 13:49:00'))` = DATE(TIMESTAMP('2020-08-26 13:49:00')), `DATE('2020-08-26 13:49:00')` = DATE('2020-08-26 13:49:00') | fields `DATE('2020-08-26')`, `DATE(TIMESTAMP('2020-08-26 13:49:00'))`, `DATE('2020-08-26 13:49:00')`
    fetched rows / total rows = 1/1
    +----------------------+------------------------------------------+-------------------------------+
    | DATE('2020-08-26')   | DATE(TIMESTAMP('2020-08-26 13:49:00'))   | DATE('2020-08-26 13:49:00')   |
    |----------------------+------------------------------------------+-------------------------------|
    | 2020-08-26           | 2020-08-26                               | 2020-08-26                    |
    +----------------------+------------------------------------------+-------------------------------+
...
Example::
    ...
    >od source=people | eval `TIME('13:49:00')` = TIME('13:49:00'), `TIME(TIMESTAMP('2020-08-26 13:49:00'))` = TIME(TIMESTAMP('2020-08-26 13:49:00')), `TIME('2020-08-26 13:49:00')` = TIME('2020-08-26 13:49:00') | fields `TIME('13:49:00')`, `TIME(TIMESTAMP('2020-08-26 13:49:00'))`, `TIME('2020-08-26 13:49:00')`
    fetched rows / total rows = 1/1
    +--------------------+------------------------------------------+-------------------------------+
    | TIME('13:49:00')   | TIME(TIMESTAMP('2020-08-26 13:49:00'))   | TIME('2020-08-26 13:49:00')   |
    |--------------------+------------------------------------------+-------------------------------|
    | 13:49:00           | 13:49:00                                 | 13:49:00                      |
    +--------------------+------------------------------------------+-------------------------------+
