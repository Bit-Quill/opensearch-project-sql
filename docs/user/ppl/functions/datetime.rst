...
Example::
    ...
    os> source=people | eval `FROM_UNIXTIME(1220249547)` = FROM_UNIXTIME(1220249547), `FROM_UNIXTIME(1220249547, '%T')` = FROM_UNIXTIME(1220249547, '%T') | fields `FROM_UNIXTIME(1220249547)`, `FROM_UNIXTIME(1220249547, '%T')`
    fetched rows / total rows = 1/1
    +-----------------------------+-----------------------------------+
...
Example::
    ...
    os> source=people | eval `UNIX_TIMESTAMP(20771122143845)` = UNIX_TIMESTAMP(20771122143845), `UNIX_TIMESTAMP(TIMESTAMP('1996-11-15 17:05:42'))` = UNIX_TIMESTAMP(TIMESTAMP('1996-11-15 17:05:42')) | fields `UNIX_TIMESTAMP(20771122143845)`, `UNIX_TIMESTAMP(TIMESTAMP('1996-11-15 17:05:42'))`
    fetched rows / total rows = 1/1
    +----------------------------------+----------------------------------------------------+
