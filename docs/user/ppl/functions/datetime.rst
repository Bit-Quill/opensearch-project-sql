...
Example::
    ...
    os> source=people | eval `DATETIME('2008-12-25 05:30:00+00:00', 'America/Los_Angeles')` = DATETIME('2008-12-25 05:30:00+00:00', 'America/Los_Angeles'), `DATETIME('2004-02-28 23:00:00-10:00', '+10:00')` = DATETIME('2004-02-28 23:00:00-10:00', '+10:00'), `DATETIME('2008-01-01 02:00:00', '-13:00')` = DATETIME('2008-01-01 02:00:00', '-13:00') | fields `DATETIME('2008-12-25 05:30:00+00:00', 'America/Los_Angeles')`, `DATETIME('2004-02-28 23:00:00-10:00', '+10:00')`, `DATETIME('2008-01-01 02:00:00', '-13:00')`
    fetched rows / total rows = 1/1
    +----------------------------------------------------------------+---------------------------------------------------+---------------------------------------------+
    | DATETIME('2008-12-25 05:30:00+00:00', 'America/Los_Angeles')   | DATETIME('2004-02-28 23:00:00-10:00', '+10:00')   | DATETIME('2008-01-01 02:00:00', '-13:00')   |
    |----------------------------------------------------------------+---------------------------------------------------+---------------------------------------------|
