...
public class MathematicalFunction {
    ...
    private static DefaultFunctionResolver abs() {
        return define(
            ...
            impl(nullMissingHandling(v -> new ExprIntegerValue(Math.abs(v.integerValue()))), INTEGER, INTEGER),
            ...
            impl(nullMissingHandling(v -> new ExprDoubleValue(Math.abs(v.doubleValue()))), DOUBLE, DOUBLE)
        );
    }
    ...
    private static DefaultFunctionResolver ceil() {
        return define(
            ...
            impl(nullMissingHandling(v -> new ExprLongValue(Math.ceil(v.doubleValue()))), LONG, DOUBLE)
        );
    }
    ...
    private static DefaultFunctionResolver conv() {
        return define(
            ...
            impl(
                nullMissingHandling(
                    (x, a, b) -> new ExprStringValue(
                        Integer.toString(Integer.parseInt(x.stringValue(), a.integerValue()), b.integerValue())
                    )
                ),
                STRING,
                STRING,
            ...
            impl(
                nullMissingHandling(
                    (x, a, b) -> new ExprStringValue(
                        Integer.toString(Integer.parseInt(x.integerValue().toString(), a.integerValue()), b.integerValue())
                    )
                ),
                STRING,
                INTEGER,
    ...
    private static DefaultFunctionResolver crc32() {
        return define(BuiltinFunctionName.CRC32.getName(), impl(nullMissingHandling(v -> {
            CRC32 crc = new CRC32();
    ...
    private static DefaultFunctionResolver exp() {
        return baseMathFunction(BuiltinFunctionName.EXP.getName(), v -> new ExprDoubleValue(Math.exp(v.doubleValue())), DOUBLE);
    }
    ...
    private static DefaultFunctionResolver expm1() {
        return baseMathFunction(BuiltinFunctionName.EXPM1.getName(), v -> new ExprDoubleValue(Math.expm1(v.doubleValue())), DOUBLE);
    }
    ...
    private static DefaultFunctionResolver floor() {
        return define(
            ...
            impl(nullMissingHandling(v -> new ExprLongValue(Math.floor(v.doubleValue()))), LONG, DOUBLE)
        );
    }
    ...
    private static DefaultFunctionResolver ln() {
        return baseMathFunction(
            ...
            v -> v.doubleValue() <= 0 ? ExprNullValue.of() : new ExprDoubleValue(Math.log(v.doubleValue())),
            DOUBLE
        );
    }
    ...
    private static DefaultFunctionResolver log() {
        ImmutableList.Builder<SerializableFunction<FunctionName, Pair<FunctionSignature, FunctionBuilder>>> builder =
        ...
        for (ExprType type : ExprCoreType.numberTypes()) {
            builder.add(
                impl(
                    nullMissingHandling(v -> v.doubleValue() <= 0 ? ExprNullValue.of() : new ExprDoubleValue(Math.log(v.doubleValue()))),
                    DOUBLE,
                    type
                )
            );
        ...
        for (ExprType baseType : ExprCoreType.numberTypes()) {
            for (ExprType numberType : ExprCoreType.numberTypes()) {
                builder.add(
                    impl(
                        nullMissingHandling(
                            (b, x) -> b.doubleValue() <= 0 || x.doubleValue() <= 0
                                ? ExprNullValue.of()
    ...
    private static DefaultFunctionResolver log10() {
        return baseMathFunction(
            ...
            v -> v.doubleValue() <= 0 ? ExprNullValue.of() : new ExprDoubleValue(Math.log10(v.doubleValue())),
            DOUBLE
        );
    }
    ...
    private static DefaultFunctionResolver log2() {
        return baseMathFunction(
            ...
            v -> v.doubleValue() <= 0 ? ExprNullValue.of() : new ExprDoubleValue(Math.log(v.doubleValue()) / Math.log(2)),
            DOUBLE
        );
    }
    ...
    private static DefaultFunctionResolver mod() {
        return define(
            ...
            impl(
                nullMissingHandling(
                    (v1, v2) -> v2.byteValue() == 0 ? ExprNullValue.of() : new ExprByteValue(v1.byteValue() % v2.byteValue())
                ),
                BYTE,
                BYTE,
                BYTE
            ...
            impl(
                nullMissingHandling(
                    (v1, v2) -> v2.shortValue() == 0 ? ExprNullValue.of() : new ExprShortValue(v1.shortValue() % v2.shortValue())
                ),
                SHORT,
                SHORT,
                SHORT
            ...
            impl(
                nullMissingHandling(
                    (v1, v2) -> v2.shortValue() == 0
                        ? ExprNullValue.of()
                        : new ExprIntegerValue(Math.floorMod(v1.integerValue(), v2.integerValue()))
                ),
                INTEGER,
                INTEGER,
                INTEGER
            ...
            impl(
                nullMissingHandling(
                    (v1, v2) -> v2.shortValue() == 0 ? ExprNullValue.of() : new ExprFloatValue(v1.floatValue() % v2.floatValue())
                ),
                FLOAT,
                FLOAT,
                FLOAT
            ...
            impl(
                nullMissingHandling(
                    (v1, v2) -> v2.shortValue() == 0 ? ExprNullValue.of() : new ExprDoubleValue(v1.doubleValue() % v2.doubleValue())
                ),
                DOUBLE,
                DOUBLE,
                DOUBLE
    ...
    private static DefaultFunctionResolver pi() {
        return define(BuiltinFunctionName.PI.getName(), impl(() -> new ExprDoubleValue(Math.PI), DOUBLE));
    }
    ...
    private List<SerializableFunction<FunctionName, Pair<FunctionSignature, FunctionBuilder>>> powerFunctionImpl() {
        return Arrays.asList(
            impl(nullMissingHandling((v1, v2) -> new ExprDoubleValue(Math.pow(v1.shortValue(), v2.shortValue()))), DOUBLE, SHORT, SHORT),
            impl(
                nullMissingHandling((v1, v2) -> new ExprDoubleValue(Math.pow(v1.integerValue(), v2.integerValue()))),
                DOUBLE,
                INTEGER,
                INTEGER
            ),
            impl(nullMissingHandling((v1, v2) -> new ExprDoubleValue(Math.pow(v1.longValue(), v2.longValue()))), DOUBLE, LONG, LONG),
            impl(
                nullMissingHandling(
                    (v1, v2) -> v1.floatValue() <= 0 && v2.floatValue() != Math.floor(v2.floatValue())
                        ? ExprNullValue.of()
            ...
            impl(
                nullMissingHandling(
                    (v1, v2) -> v1.doubleValue() <= 0 && v2.doubleValue() != Math.floor(v2.doubleValue())
                        ? ExprNullValue.of()
    ...
    private static DefaultFunctionResolver rand() {
        return define(
            ...
            impl(nullMissingHandling(v -> new ExprFloatValue(new Random(v.integerValue()).nextFloat())), FLOAT, INTEGER)
        );
    }
    ...
    private static DefaultFunctionResolver rint() {
        return baseMathFunction(BuiltinFunctionName.RINT.getName(), v -> new ExprDoubleValue(Math.rint(v.doubleValue())), DOUBLE);
    }
    ...
    private static DefaultFunctionResolver round() {
        return define(
            ...
            // rand(x)
            impl(nullMissingHandling(v -> new ExprLongValue((long) Math.round(v.integerValue()))), LONG, INTEGER),
            impl(nullMissingHandling(v -> new ExprLongValue((long) Math.round(v.longValue()))), LONG, LONG),
            impl(nullMissingHandling(v -> new ExprDoubleValue((double) Math.round(v.floatValue()))), DOUBLE, FLOAT),
            impl(
                nullMissingHandling(
                    v -> new ExprDoubleValue(new BigDecimal(v.doubleValue()).setScale(0, RoundingMode.HALF_UP).doubleValue())
                ),
                DOUBLE,
                DOUBLE
            ),
            ...
            impl(
                nullMissingHandling(
                    (x, d) -> new ExprLongValue(
                        new BigDecimal(x.integerValue()).setScale(d.integerValue(), RoundingMode.HALF_UP).longValue()
                    )
                ),
                LONG,
                INTEGER,
            ...
            impl(
                nullMissingHandling(
                    (x, d) -> new ExprLongValue(new BigDecimal(x.longValue()).setScale(d.integerValue(), RoundingMode.HALF_UP).longValue())
                ),
                LONG,
                LONG,
                INTEGER
            ...
            impl(
                nullMissingHandling(
                    (x, d) -> new ExprDoubleValue(
                        new BigDecimal(x.floatValue()).setScale(d.integerValue(), RoundingMode.HALF_UP).doubleValue()
                    )
                ),
                DOUBLE,
                FLOAT,
            ...
            impl(
                nullMissingHandling(
                    (x, d) -> new ExprDoubleValue(
                        new BigDecimal(x.doubleValue()).setScale(d.integerValue(), RoundingMode.HALF_UP).doubleValue()
                    )
                ),
                DOUBLE,
                DOUBLE,
    ...
    private static DefaultFunctionResolver sign() {
        return baseMathFunction(BuiltinFunctionName.SIGN.getName(), v -> new ExprIntegerValue(Math.signum(v.doubleValue())), INTEGER);
    }
    ...
    private static DefaultFunctionResolver signum() {
        return baseMathFunction(BuiltinFunctionName.SIGNUM.getName(), v -> new ExprIntegerValue(Math.signum(v.doubleValue())), INTEGER);
    }
    ...
    private static DefaultFunctionResolver sinh() {
        return baseMathFunction(BuiltinFunctionName.SINH.getName(), v -> new ExprDoubleValue(Math.sinh(v.doubleValue())), DOUBLE);
    }
    ...
    private static DefaultFunctionResolver sqrt() {
        return baseMathFunction(
            ...
            v -> v.doubleValue() < 0 ? ExprNullValue.of() : new ExprDoubleValue(Math.sqrt(v.doubleValue())),
            DOUBLE
        );
    }
    ...
    private static DefaultFunctionResolver cbrt() {
        return baseMathFunction(BuiltinFunctionName.CBRT.getName(), v -> new ExprDoubleValue(Math.cbrt(v.doubleValue())), DOUBLE);
    }
    ...
    private static DefaultFunctionResolver truncate() {
        return define(
            ...
            impl(
                nullMissingHandling(
                    (x, y) -> new ExprLongValue(
                        BigDecimal.valueOf(x.integerValue()).setScale(y.integerValue(), RoundingMode.DOWN).longValue()
                    )
                ),
                LONG,
                INTEGER,
            ...
            impl(
                nullMissingHandling(
                    (x, y) -> new ExprLongValue(BigDecimal.valueOf(x.longValue()).setScale(y.integerValue(), RoundingMode.DOWN).longValue())
                ),
                LONG,
                LONG,
                INTEGER
            ...
            impl(
                nullMissingHandling(
                    (x, y) -> new ExprDoubleValue(
                        BigDecimal.valueOf(x.floatValue()).setScale(y.integerValue(), RoundingMode.DOWN).doubleValue()
                    )
                ),
                DOUBLE,
                FLOAT,
            ...
            impl(
                nullMissingHandling(
                    (x, y) -> new ExprDoubleValue(
                        BigDecimal.valueOf(x.doubleValue()).setScale(y.integerValue(), RoundingMode.DOWN).doubleValue()
                    )
                ),
                DOUBLE,
                DOUBLE,
        ...
        return define(
            ...
            ExprCoreType.numberTypes()
                ...
                .map(
                    type -> impl(
                        nullMissingHandling(
                            v -> v.doubleValue() < -1 || v.doubleValue() > 1
                                ? ExprNullValue.of()
    ...
    private static DefaultFunctionResolver atan() {
        ...
        for (ExprType type : ExprCoreType.numberTypes()) {
            builder.add(impl(nullMissingHandling(x -> new ExprDoubleValue(Math.atan(x.doubleValue()))), type, DOUBLE));
            builder.add(
                impl(nullMissingHandling((y, x) -> new ExprDoubleValue(Math.atan2(y.doubleValue(), x.doubleValue()))), DOUBLE, type, type)
            );
        }
    ...
    private static DefaultFunctionResolver cos() {
        return baseMathFunction(BuiltinFunctionName.COS.getName(), v -> new ExprDoubleValue(Math.cos(v.doubleValue())), DOUBLE);
    }
    ...
    private static DefaultFunctionResolver cosh() {
        return baseMathFunction(BuiltinFunctionName.COSH.getName(), v -> new ExprDoubleValue(Math.cosh(v.doubleValue())), DOUBLE);
    }
    ...
    private static DefaultFunctionResolver cot() {
        return define(BuiltinFunctionName.COT.getName(), ExprCoreType.numberTypes().stream().map(type -> impl(nullMissingHandling(v -> {
    ...
    private static DefaultFunctionResolver degrees() {
        return baseMathFunction(BuiltinFunctionName.DEGREES.getName(), v -> new ExprDoubleValue(Math.toDegrees(v.doubleValue())), DOUBLE);
    }
    ...
    private static DefaultFunctionResolver radians() {
        return baseMathFunction(BuiltinFunctionName.RADIANS.getName(), v -> new ExprDoubleValue(Math.toRadians(v.doubleValue())), DOUBLE);
    }
    ...
    private static DefaultFunctionResolver sin() {
        return baseMathFunction(BuiltinFunctionName.SIN.getName(), v -> new ExprDoubleValue(Math.sin(v.doubleValue())), DOUBLE);
    }
    ...
    private static DefaultFunctionResolver tan() {
        return baseMathFunction(BuiltinFunctionName.TAN.getName(), v -> new ExprDoubleValue(Math.tan(v.doubleValue())), DOUBLE);
    }
}
