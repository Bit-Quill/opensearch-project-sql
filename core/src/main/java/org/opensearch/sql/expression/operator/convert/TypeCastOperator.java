...
public class TypeCastOperator {
    ...
    private static DefaultFunctionResolver castToString() {
        return FunctionDSL.define(
            ...
            Stream.concat(
                Arrays.asList(BYTE, SHORT, INTEGER, LONG, FLOAT, DOUBLE, BOOLEAN, TIME, DATE, TIMESTAMP, DATETIME)
                    .stream()
                    .map(type -> impl(nullMissingHandling((v) -> new ExprStringValue(v.value().toString())), STRING, type)),
    ...
    private static DefaultFunctionResolver castToByte() {
        return FunctionDSL.define(
            ...
            impl(nullMissingHandling((v) -> new ExprByteValue(Byte.valueOf(v.stringValue()))), BYTE, STRING),
            impl(nullMissingHandling((v) -> new ExprByteValue(v.byteValue())), BYTE, DOUBLE),
            impl(nullMissingHandling((v) -> new ExprByteValue(v.booleanValue() ? 1 : 0)), BYTE, BOOLEAN)
        );
    }
    ...
    private static DefaultFunctionResolver castToShort() {
        return FunctionDSL.define(
            ...
            impl(nullMissingHandling((v) -> new ExprShortValue(Short.valueOf(v.stringValue()))), SHORT, STRING),
            impl(nullMissingHandling((v) -> new ExprShortValue(v.shortValue())), SHORT, DOUBLE),
            impl(nullMissingHandling((v) -> new ExprShortValue(v.booleanValue() ? 1 : 0)), SHORT, BOOLEAN)
        );
    }
    ...
    private static DefaultFunctionResolver castToInt() {
        return FunctionDSL.define(
            ...
            impl(nullMissingHandling((v) -> new ExprIntegerValue(Integer.valueOf(v.stringValue()))), INTEGER, STRING),
            impl(nullMissingHandling((v) -> new ExprIntegerValue(v.integerValue())), INTEGER, DOUBLE),
            impl(nullMissingHandling((v) -> new ExprIntegerValue(v.booleanValue() ? 1 : 0)), INTEGER, BOOLEAN)
        );
    }
    ...
    private static DefaultFunctionResolver castToLong() {
        return FunctionDSL.define(
            ...
            impl(nullMissingHandling((v) -> new ExprLongValue(Long.valueOf(v.stringValue()))), LONG, STRING),
            impl(nullMissingHandling((v) -> new ExprLongValue(v.longValue())), LONG, DOUBLE),
            impl(nullMissingHandling((v) -> new ExprLongValue(v.booleanValue() ? 1L : 0L)), LONG, BOOLEAN)
        );
    }
    ...
    private static DefaultFunctionResolver castToFloat() {
        return FunctionDSL.define(
            ...
            impl(nullMissingHandling((v) -> new ExprFloatValue(Float.valueOf(v.stringValue()))), FLOAT, STRING),
            impl(nullMissingHandling((v) -> new ExprFloatValue(v.floatValue())), FLOAT, DOUBLE),
            impl(nullMissingHandling((v) -> new ExprFloatValue(v.booleanValue() ? 1f : 0f)), FLOAT, BOOLEAN)
        );
    }
    ...
    private static DefaultFunctionResolver castToDouble() {
        return FunctionDSL.define(
            ...
            impl(nullMissingHandling((v) -> new ExprDoubleValue(Double.valueOf(v.stringValue()))), DOUBLE, STRING),
            impl(nullMissingHandling((v) -> new ExprDoubleValue(v.doubleValue())), DOUBLE, DOUBLE),
            impl(nullMissingHandling((v) -> new ExprDoubleValue(v.booleanValue() ? 1D : 0D)), DOUBLE, BOOLEAN)
        );
    }
    ...
    private static DefaultFunctionResolver castToBoolean() {
        return FunctionDSL.define(
            ...
            impl(nullMissingHandling((v) -> ExprBooleanValue.of(Boolean.valueOf(v.stringValue()))), BOOLEAN, STRING),
            impl(nullMissingHandling((v) -> ExprBooleanValue.of(v.doubleValue() != 0)), BOOLEAN, DOUBLE),
    ...
    private static DefaultFunctionResolver castToTimestamp() {
        return FunctionDSL.define(
            ...
            impl(nullMissingHandling((v) -> new ExprTimestampValue(v.stringValue())), TIMESTAMP, STRING),
            impl(nullMissingHandling((v) -> new ExprTimestampValue(v.timestampValue())), TIMESTAMP, DATETIME),
            impl(nullMissingHandling((v) -> new ExprTimestampValue(v.timestampValue())), TIMESTAMP, DATE),
            implWithProperties(
                nullMissingHandlingWithProperties((fp, v) -> new ExprTimestampValue(((ExprTimeValue) v).timestampValue(fp))),
                TIMESTAMP,
                TIME
            ),
    ...
    private static DefaultFunctionResolver castToDatetime() {
        return FunctionDSL.define(
            ...
            impl(nullMissingHandling((v) -> new ExprDatetimeValue(v.datetimeValue())), DATETIME, TIMESTAMP),
            impl(nullMissingHandling((v) -> new ExprDatetimeValue(v.datetimeValue())), DATETIME, DATE),
            implWithProperties(
                nullMissingHandlingWithProperties((fp, v) -> new ExprDatetimeValue(((ExprTimeValue) v).datetimeValue(fp))),
                DATETIME,
                TIME
            ),
