...
public class FunctionDSL {
     ...
     */
    public static SerializableFunction<FunctionName, Pair<FunctionSignature, FunctionBuilder>> implWithProperties(
        SerializableFunction<FunctionProperties, ExprValue> function,
        ExprType returnType
    ) {
        return functionName -> {
            FunctionSignature functionSignature = new FunctionSignature(functionName, Collections.emptyList());
            FunctionBuilder functionBuilder = (functionProperties, arguments) -> new FunctionExpression(
                functionName,
    ...
    public static SerializableFunction<FunctionName, Pair<FunctionSignature, FunctionBuilder>> implWithProperties(
        ...
        return functionName -> {
            FunctionSignature functionSignature = new FunctionSignature(functionName, Collections.singletonList(argsType));
            FunctionBuilder functionBuilder = (functionProperties, arguments) -> new FunctionExpression(functionName, arguments) {
                @Override
                public ExprValue valueOf(Environment<Expression, ExprValue> valueEnv) {
    ...
    public static SerializableFunction<FunctionName, Pair<FunctionSignature, FunctionBuilder>> implWithProperties(
        ...
        return functionName -> {
            FunctionSignature functionSignature = new FunctionSignature(functionName, Arrays.asList(args1Type, args2Type));
            FunctionBuilder functionBuilder = (functionProperties, arguments) -> new FunctionExpression(functionName, arguments) {
                @Override
                public ExprValue valueOf(Environment<Expression, ExprValue> valueEnv) {
    ...
    public static SerializableFunction<FunctionName, Pair<FunctionSignature, FunctionBuilder>> implWithProperties(
        ...
        return functionName -> {
            FunctionSignature functionSignature = new FunctionSignature(functionName, Arrays.asList(args1Type, args2Type, args3Type));
            FunctionBuilder functionBuilder = (functionProperties, arguments) -> new FunctionExpression(functionName, arguments) {
                @Override
                public ExprValue valueOf(Environment<Expression, ExprValue> valueEnv) {
                    ExprValue arg1 = arguments.get(0).valueOf(valueEnv);
    ...
    public static SerializableFunction<FunctionName, Pair<FunctionSignature, FunctionBuilder>> impl(
        ...
        return implWithProperties((fp, arg1, arg2) -> function.apply(arg1, arg2), returnType, args1Type, args2Type);
    }
    ...
    public static SerializableFunction<FunctionName, Pair<FunctionSignature, FunctionBuilder>> impl(
        ...
        return functionName -> {
            FunctionSignature functionSignature = new FunctionSignature(
                functionName,
                Arrays.asList(args1Type, args2Type, args3Type, args4Type)
            );
            FunctionBuilder functionBuilder = (functionProperties, arguments) -> new FunctionExpression(functionName, arguments) {
                @Override
                public ExprValue valueOf(Environment<Expression, ExprValue> valueEnv) {
     ...
     */
    public static SerializableBiFunction<FunctionProperties, ExprValue, ExprValue> nullMissingHandlingWithProperties(
     ...
     * with default NULL and MISSING handling.
     */
    public static SerializableTriFunction<FunctionProperties, ExprValue, ExprValue, ExprValue> nullMissingHandlingWithProperties(
