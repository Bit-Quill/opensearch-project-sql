...
public class ExprDatetimeValue extends AbstractExprValue {
    ...
    public ExprDatetimeValue(String datetime) {
        try {
            ...
            throw new SemanticCheckException(
                String.format("datetime:%s in unsupported format, please " + "use yyyy-MM-dd HH:mm:ss[.SSSSSSSSS]", datetime)
            );
        }
    }
    ...
    public String value() {
        return String.format(
            ...
            DateTimeFormatter.ISO_TIME.format((datetime.getNano() == 0) ? datetime.truncatedTo(ChronoUnit.SECONDS) : datetime)
        );
    }
