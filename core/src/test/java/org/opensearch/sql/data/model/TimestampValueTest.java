...
public class TimestampValueTest {
  ...
  public void timeValueInterfaceTest() {
    ...
    assertEquals(today.atTime(1, 1, 1), LocalDateTime.ofInstant(timeValue.timestampValue(functionProperties), UTC_ZONE_ID));
  ...
  public void timestampValueInterfaceTest() {
    ...
    assertEquals(LocalDateTime.parse("2020-07-07T01:01:01"), LocalDateTime.ofInstant(timestampValue.timestampValue(), UTC_ZONE_ID));
  ...
  public void dateValueInterfaceTest() {
    ...
    assertEquals(LocalDateTime.parse("2012-07-07T00:00:00"), LocalDateTime.ofInstant(dateValue.timestampValue(), UTC_ZONE_ID));
  ...
  public void stringDateTimeValue() {
    ...
    assertEquals(LocalDateTime.parse("2020-08-17T19:44:00"), LocalDateTime.ofInstant(stringValue.timestampValue(), UTC_ZONE_ID));
  ...
  public void stringDateValue() {
    ...
    assertEquals(LocalDateTime.parse("2020-08-17T00:00:00"), LocalDateTime.ofInstant(stringValue.timestampValue(), UTC_ZONE_ID));
    assertEquals(LocalDate.parse("2020-08-17"), stringValue.dateValue());
  ...
  public void timestampWithVariableNanoPrecision() {
    ...
    for (int nanoPrecision = 1; nanoPrecision <= NANOS_PRECISION_MAX; nanoPrecision++) {
      ...
      assertEquals(LocalDateTime.parse(localDateTime), LocalDateTime.ofInstant(timestampValue.timestampValue(), UTC_ZONE_ID));
    }
  }
