...
public class FromUnixTimeTest extends DateTimeTestBase {
  ...
  public void checkOfLong(Long value) {
    ...
    assertEquals(
        ...
        LocalDateTime.ofInstant(eval(fromUnixTime(DSL.literal(new ExprLongValue(value)))).timestampValue(), ZoneOffset.UTC));
  }
  ...
  public void checkOfDouble(Double value) {
    ...
    assertEquals(
        LocalDateTime.ofEpochSecond(intPart, (int) Math.round(fracPart * 1E9), ZoneOffset.UTC),
        LocalDateTime.ofInstant(eval(fromUnixTime(DSL.literal(new ExprDoubleValue(value)))).timestampValue(), ZoneOffset.UTC),
        valueAsString);
  }
